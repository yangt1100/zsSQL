...
public class BlobValueViewController {
    ...
    public void init(Object val) {
        ...
        blobValueEdit.setEditable(false);
        if (null != val) {
        ...
        sizeLabel.setText(String.format("字节数:  %d bytes", null == val? 0 : val.toString().getBytes().length));
